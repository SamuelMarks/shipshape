...
export class BatchPage {
  ...
  readonly statusOptions = ['all', 'Queued', 'Running', 'Complete', 'Failed'] as const;
  readonly ownerOptions = ['all', 'Core Platform', 'Data Ops', 'Runtime'] as const;
  ...
  private matchesFilter(batch: BatchRun, filters: BatchFilters): boolean {
    ...
    const matchesOwner = filters.owner === 'all' || batch.owner === filters.owner;
